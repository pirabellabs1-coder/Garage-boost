...
module.exports = {
  ...
  'batterie-voiture-signes-faiblesse-duree-vie': [
    { q: "Combien de temps dure une batterie de voiture ?", a: "En moyenne 4 à 6 ans, mais cela varie fortement selon l'usage. Les petits trajets urbains (fréquents à Marseille) ne rechargent jamais complètement la batterie et la vieillissent prématurément. La chaleur accélère aussi son usure. Certaines tiennent 3 ans, d'autres plus de 7." },
    { q: "Quels sont les signes d'une batterie en fin de vie ?", a: "Démarrage laborieux (surtout le matin), éclairage qui faiblit au ralenti, équipements électriques capricieux, voyant batterie, besoin répété de la recharger ou de démarrer aux câbles, cosses corrodées ou batterie gonflée. Au-delà de 4 ans, mieux vaut la faire tester." },
    { q: "La chaleur abîme-t-elle vraiment la batterie ?", a: "Oui. La chaleur accélère l'évaporation de l'électrolyte et la corrosion interne, dégradant la capacité de façon irréversible. Le froid, lui, révèle la faiblesse : une batterie usée par l'été lâche souvent au premier coup de froid. À Marseille, la chaleur estivale est un facteur majeur d'usure." },
    { q: "Faut-il une batterie spéciale pour le Stop & Start ?", a: "Oui. Les véhicules équipés du Stop & Start exigent des batteries spécifiques (AGM ou EFB), plus endurantes. Monter une batterie classique réduit fortement sa durée de vie et peut perturber le système. Nous installons toujours une batterie adaptée à votre véhicule." }
  ],

  'controle-avant-achat-voiture-occasion': [
    { q: "Pourquoi faire un contrôle avant achat d'une voiture d'occasion ?", a: "Parce qu'un véhicule peut paraître impeccable et cacher une distribution en fin de vie, un embrayage usé ou un passé d'accident. Un contrôle professionnel (sur le pont + valise diagnostic) révèle l'état réel, vous évite un achat à problèmes et vous donne des arguments de négociation. C'est neutre : le garage n'a aucun intérêt dans la vente." },
    { q: "Quels sont les points les plus importants à vérifier ?", a: "Le moteur (démarrage à froid, fumées, fuites), les grosses échéances cachées (distribution, embrayage), la carrosserie (jeux, peinture, traces d'accident), l'électronique (codes défauts), la cohérence du kilométrage et les documents. Et toujours un essai routier complet." },
    { q: "Combien coûte un contrôle avant achat ?", a: "Quelques dizaines d'euros selon le véhicule — sans commune mesure avec une réparation à quatre chiffres découverte après l'achat. C'est l'un des meilleurs investissements pour acheter serein. Chez Garage Boost, le contrôle inclut examen mécanique, diagnostic et compte-rendu honnête." },
    { q: "Un contrôle technique récent suffit-il ?", a: "Non. Le contrôle technique vérifie la conformité réglementaire et la sécurité à un instant T, mais n'évalue pas l'usure mécanique (distribution, embrayage), l'état réel du moteur ou un passé d'accident. Un contrôle avant achat est bien plus approfondi et orienté vers la valeur réelle du véhicule." }
  ],

  'boite-automatique-entretien-vidange': [
    { q: "Faut-il vidanger une boîte automatique ?", a: "Oui, malgré l'idée reçue du « sans entretien ». L'huile de boîte automatique (ATF) transmet la puissance et pilote les passages ; elle se dégrade avec le temps. La plupart des spécialistes recommandent une vidange tous les 60 000 à 100 000 km selon le type de boîte et l'usage. C'est peu coûteux face au remplacement d'une boîte." },
    { q: "Quels sont les signes d'une boîte automatique fatiguée ?", a: "À-coups ou secousses aux passages de rapports, passages retardés ou hésitants, régime qui s'emballe sans accélération (patinage), bruits anormaux, voyant de boîte, passage en mode dégradé, odeur de brûlé ou huile très foncée. Au moindre symptôme, un diagnostic rapide limite la réparation." },
    { q: "Tous les types de boîtes automatiques s'entretiennent-ils pareil ?", a: "Non. Boîte à convertisseur, robotisée à double embrayage (DSG, EDC, PDK) et CVT ont des spécificités. Les boîtes à double embrayage ont des embrayages et une mécatronique sensibles qui demandent un suivi particulier. Connaître le type de votre boîte détermine l'entretien adapté." },
    { q: "Combien coûte une réparation de boîte automatique ?", a: "Une vidange reste modeste, mais le remplacement ou la réparation lourde d'une boîte automatique (mécatronique, embrayages, boîte complète) peut atteindre plusieurs milliers d'euros. D'où l'importance de l'entretien préventif : la vidange régulière est l'investissement le plus rentable pour préserver la transmission." }
  ]
